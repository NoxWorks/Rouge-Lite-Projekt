...
- Prozeduraler Dungeon-Generator
- Spielerbewegung und Kollision
- Erste Gegner-Logik
- Eigene Pixel-Art-Assets

## 🛠️ Technologien

- Godot Engine
- GDScript
- C# (Wenn nötig für einzelne Code segmente)
...
- Hier zu den [Bugs](project/docs/Debugging/debug.md)

- Hier zu den [Assets](project/docs/assets.md)
